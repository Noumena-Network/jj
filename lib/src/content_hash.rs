...
pub use blake2::digest::Update as DigestUpdate;
...
pub fn blake2b_hash(x: &(impl ContentHash + ?Sized)) -> blake2::digest::Output<Blake2b512> {
...
mod tests {
    ...
    fn hash(x: &(impl ContentHash + ?Sized)) -> blake2::digest::Output<Blake2b512> {
        blake2b_hash(x)
    }
}
