...
enum Command {
    ...
    New(new::NewArgs),
    Next(next::NextArgs),
    Push(ncode_push::PushArgs),
    Land(ncode_push::LandArgs),
    #[command(subcommand)]
...
pub async fn run_command(ui: &mut Ui, command_helper: &CommandHelper) -> Result<(), CommandError> {
    ...
    match &subcommand {
        ...
        Command::Clone(args) => clone::cmd_clone(ui, command_helper, args).await,
        ...
        Command::Init(args) => init::cmd_init(ui, command_helper, args).await,
        ...
        Command::Push(args) => ncode_push::cmd_push(ui, command_helper, args).await,
        Command::Land(args) => ncode_push::cmd_land(ui, command_helper, args).await,
        ...
        Command::Repo(args) => repo::cmd_repo(ui, command_helper, args).await,
